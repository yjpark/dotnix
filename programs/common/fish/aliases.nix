{ pkgs, ... }: {
  programs.fish.shellAliases = {
    ...
    set-proxy-edger = "set -gx https_proxy http://172.22.1.2:29002; set -gx http_proxy http://172.22.1.2:29002; set -gx all_proxy http://172.22.1.2:29002; set -gx NIX_CURL_FLAGS -x http://172.22.1.2:29002";
    set-proxy-a13 = "set -gx https_proxy http://172.22.1.6:29002; set -gx http_proxy http://172.22.1.6:29002; set -gx all_proxy http://172.22.1.6:29002; set -gx NIX_CURL_FLAGS -x http://172.22.1.6:29002";
